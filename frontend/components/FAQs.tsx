...
const faq: { question: string; answer: string }[] = [
  ...
  },
  {
    ...
    answer: `If you have any issues, you can reach out through the Help & Support section in the app or email us at Trash2Cash@support.com.`,
  },
];
      ...
      <View style={{ marginBottom: 16 }}>
        <FlatList
          ...
          renderItem={({ item, index }) => (
            <AccorionDemo question={`${item.question}`} answer={item.answer} />
          )}
        />
      </View>
    </Container>
          ...
          {({ open }: { open: boolean }) => (
            <>
              ...
              <Square animation="quick" rotate={open ? "180deg" : "0deg"}>
                <ChevronDown size={20} color={"#2B4B40"} />
              </Square>
            </>
          )}
        </Accordion.Trigger>
